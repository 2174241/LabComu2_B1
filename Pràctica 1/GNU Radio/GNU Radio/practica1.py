...
# Title: Lab1_Comu2_C1_2174241
# Author: 2174241_C1
# Copyright: Lab1_Comu2_C1_2174241
# Description: Practica1_Comu2_C1
...
class practica1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Lab1_Comu2_C1_2174241", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab1_Comu2_C1_2174241")
        ...
        self.qtgui_number_sink_0_3.set_title('DESVIACIÒN ESTANDAR')

        labels = ['Desviacion estandar = ', '', '', '', '',
            '', '', '', '', '']
        units = ['', '', '', '', '',
            '', '', '', '', '']
        ...
        for i in range(1):
            self.qtgui_number_sink_0_3.set_min(i, -5)
            self.qtgui_number_sink_0_3.set_max(i, 5)
        ...
        self.qtgui_number_sink_0_3.set_block_alias("Desviacion Estandar")
        ...
        for i in range(1):
            self.qtgui_number_sink_0_2.set_min(i, -5)
            self.qtgui_number_sink_0_2.set_max(i, 5)
        ...
        self.qtgui_number_sink_0_2.set_block_alias("Potencia Promedio")
        ...
        for i in range(1):
            self.qtgui_number_sink_0_1.set_min(i, -5)
        ...
        self.qtgui_number_sink_0_1.set_block_alias("RMS")
        ...
        self.qtgui_number_sink_0_0.set_block_alias("Media Cuadratica")
        ...
        self.qtgui_number_sink_0.set_block_alias("Media")
        self.epy_block_2 = epy_block_2.blk()
        self.blocks_vector_source_x_0 = blocks.vector_source_f(range (1, 9), True, 1, [])
